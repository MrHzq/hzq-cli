...
const { getFullPathBy, getFileName, getDirName } = require("../../utils/path");
...
module.exports = async (_, options = {}) => {
  ...
  let videoPathList, gifFps, startTime, duration, successList;
  ...
  const runMain = async () => {
    const currUseFfmpeg = await checkFnAndGetFfmpeg("videoToGif");
    ...
    return {
      ...
      tip: log.batchLog(videoPathList, successList),
    };
  };
